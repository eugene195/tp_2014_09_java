...
//---------------------------------------------------
    ...
    addUser: function() {
        var sessionId = $(this).siblings('.sessions__id').attr('value');
        this.controller.sendMessage({
            action: "addUser",
            sessionId: sessionId
        });
