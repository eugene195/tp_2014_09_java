...
define('tmpl/game',[],function () { return function (__fest_context){var __fest_self=this,__fest_buf="",__fest_chunks=[],__fest_chunk,__fest_attrs=[],__fest_select,__fest_if,__fest_iterator,__fest_to,__fest_fn,__fest_html="",__fest_blocks={},__fest_params,__fest_element,__fest_debug_file="",__fest_debug_line="",__fest_debug_block="",__fest_htmlchars=/[&<>"]/g,__fest_htmlchars_test=/[&<>"]/,__fest_short_tags = {"area":true,"base":true,"br":true,"col":true,"command":true,"embed":true,"hr":true,"img":true,"input":true,"keygen":true,"link":true,"meta":true,"param":true,"source":true,"wbr":true},__fest_element_stack = [],__fest_htmlhash={"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;"},__fest_jschars=/[\\'"\/\n\r\t\b\f<>]/g,__fest_jschars_test=/[\\'"\/\n\r\t\b\f<>]/,__fest_jshash={"\"":"\\\"","\\":"\\\\","/":"\\/","\n":"\\n","\r":"\\r","\t":"\\t","\b":"\\b","\f":"\\f","'":"\\'","<":"\\u003C",">":"\\u003E"},___fest_log_error;if(typeof __fest_error === "undefined"){___fest_log_error = (typeof console !== "undefined" && console.error) ? function(){return Function.prototype.apply.call(console.error, console, arguments)} : function(){};}else{___fest_log_error=__fest_error};function __fest_log_error(msg){___fest_log_error(msg+"\nin block \""+__fest_debug_block+"\" at line: "+__fest_debug_line+"\nfile: "+__fest_debug_file)}function __fest_replaceHTML(chr){return __fest_htmlhash[chr]}function __fest_replaceJS(chr){return __fest_jshash[chr]}function __fest_extend(dest, src){for(var i in src)if(src.hasOwnProperty(i))dest[i]=src[i];}function __fest_param(fn){fn.param=true;return fn}function __fest_call(fn, params,cp){if(cp)for(var i in params)if(typeof params[i]=="function"&&params[i].param)params[i]=params[i]();return fn.call(__fest_self,params)}function __fest_escapeJS(s){if (typeof s==="string") {if (__fest_jschars_test.test(s))return s.replace(__fest_jschars,__fest_replaceJS);} else if (typeof s==="undefined")return "";return s;}function __fest_escapeHTML(s){if (typeof s==="string") {if (__fest_htmlchars_test.test(s))return s.replace(__fest_htmlchars,__fest_replaceHTML);} else if (typeof s==="undefined")return "";return s;}var gameContent=__fest_context;__fest_buf+=("<div style=\"display: flex;\n  padding: 50px;\n  \"><div class=\"container-centered\"><div class=\"content-centered\"><form class=\"form\"><div class=\"form__header\"><h1 class=\"form__header__h1\">Player List</h1></div><div class=\"form__content\">");var i,snake,__fest_iterator0;try{__fest_iterator0=gameContent.snakes || {};}catch(e){__fest_iterator={};__fest_log_error(e.message);}for(i in __fest_iterator0){snake=__fest_iterator0[i];__fest_buf+=("<div class=\"form__content__menu-item\" style=\"");try{__fest_buf+=(__fest_escapeHTML("background-color: " + snake.color + "; color: white;"))}catch(e){__fest_log_error(e.message + "15");}__fest_buf+=("\"><td>");try{__fest_buf+=(__fest_escapeHTML(snake.name))}catch(e){__fest_log_error(e.message + "17");}__fest_buf+=("</td></div>");}__fest_buf+=("</div><div class=\"form__footer\"><div class=\"buttons_wrapper\"><a href=\"#\" class=\"button_orange left\">Main</a><a href=\"#scoreboard\" class=\"button right\">Scoreboard</a></div></div></form></div><canvas id=\"snakeGame\" class=\"content-centered game_background\" width=\"");try{__fest_buf+=(__fest_escapeHTML(gameContent.sizes.width))}catch(e){__fest_log_error(e.message + "31");}__fest_buf+=("\" height=\"");try{__fest_buf+=(__fest_escapeHTML(gameContent.sizes.height))}catch(e){__fest_log_error(e.message + "32");}__fest_buf+=("\"></canvas></div><div class=\"modal\"><div class=\"spinner modal__spinner\"></div><div class=\"container-centered\"><div class=\"neon content-centered modal__header\" id=\"result_message\"></div></div><div class=\"container-centered modal__footer\"><div class=\"buttons_wrapper content-centered\"><a href=\"#\" class=\"button_orange\">Main</a><button class=\"button\" id=\"game_show\">Back</button></div></div></div><div class=\"overlay\"></div></div>");__fest_to=__fest_chunks.length;if (__fest_to) {__fest_iterator = 0;for (;__fest_iterator<__fest_to;__fest_iterator++) {__fest_chunk=__fest_chunks[__fest_iterator];if (typeof __fest_chunk==="string") {__fest_html+=__fest_chunk;} else {__fest_fn=__fest_blocks[__fest_chunk.name];if (__fest_fn) __fest_html+=__fest_call(__fest_fn,__fest_chunk.params,__fest_chunk.cp);}}return __fest_html+__fest_buf;} else {return __fest_buf;}} ; });
